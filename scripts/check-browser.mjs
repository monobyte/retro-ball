...
check('mechanical-courses');
check('mixed-mechanics');
check('reactive-obstacles');
check('reactive-rendering');
check('signals');
check('obstacle-contracts');
check('puzzles');
check('puzzle-rendering');
check('object-courses');

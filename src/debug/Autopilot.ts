...
export const CIRCUIT_ROUTE: Waypoint[] = [
  ...
  { x: 31.5, z: -38, speed: 7, label: 'high platform (checkpoint B)' },
  ...
  { x: 2, z: -39.5, speed: 8 },
  { x: -2, z: -40, speed: 6 },
  { x: -2, z: -43, speed: 6, label: 'ledge C' },
  { x: -2, z: -48, speed: 8 },
  { x: -2, z: -52, speed: 7, label: 'checkpoint C' },
  { x: -6, z: -52, speed: 7 },
  { x: -10, z: -52, speed: 7, label: 'laser gate' },
  { x: -13.5, z: -52, speed: 6, radius: 0.8, waitForY: 8.7, label: 'elevator 2' },
  { x: -13.5, z: -47.5, speed: 7, label: 'skyway start (checkpoint D)' },
  { x: -13.5, z: -40, speed: 9 },
  { x: -13.5, z: -34, speed: 9 },
  { x: -13.5, z: -27, speed: 8, label: 'skyway end' },
  { x: -13.5, z: -25, speed: 5 },
  { x: -13.5, z: -23.2, speed: 4, radius: 0.7, label: 'jump pad 2' },
  { x: -19.5, z: -16.5, radius: 2.5, speed: 6, label: 'island (checkpoint E)' },
  { x: -20, z: -12.5, speed: 6, label: 'drop ramp' },
  { x: -20, z: -7, speed: 7 },
  { x: -20, z: -4.8, speed: 5, radius: 0.8, label: 'final approach' },
  { x: -16, z: -5, speed: 7 },
